...
class MeliPayamakService
{
    ...
    public function addContact()
    {
        ...
        $sms_client = new \SoapClient('http://api.payamak-panel.com/post/contacts.asmx?wsdl', ['encoding' => 'UTF-8']);
        $parameters['username'] = '***';
        $parameters['password'] = '***';
    ...
    {
        ini_set('soap.wsdl_cache_enabled', '0');
        $sms_client = new \SoapClient('http://api.payamak-panel.com/post/schedule.asmx?wsdl', ['encoding' => 'UTF-8']);
    ...
    public function getInboxCountSoapClient()
    {
        ...
        ini_set('soap.wsdl_cache_enabled', '0');
        $sms_client = new \SoapClient('http://api.payamak-panel.com/post/receive.asmx?wsdl', ['encoding' => 'UTF-8']);
    ...
    public function sendSmsSoapClient($from, array $to, $text, $isFlash = true)
    {
        ...
        try {
            ...
            $GetCreditResult = $client->GetCredit(['username' => $this->username, 'password' => $this->password])->GetCreditResult;
